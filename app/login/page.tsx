    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 xl:px-12 py-12">
        <div className="mx-auto w-full max-w-sm">
          ...
          <h1 className="font-serif text-2xl font-medium italic text-foreground mb-2">Welcome <span className="text-primary">back</span></h1>
      ...
      <div className="hidden lg:block lg:w-1/2 xl:w-3/5 relative">
        ...
        <div className="absolute bottom-12 left-12 right-12 z-20">
          <blockquote className="text-lg text-foreground/90 italic mb-4">
            {`"Rydex made my weekend getaway unforgettable. The car was perfect and the experience was seamless."`}
          </blockquote>
          <p className="text-muted-foreground">- Sarah M., Premium Member</p>
        </div>
      </div>
    </div>
  )
